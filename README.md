...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dtool_cli-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6454&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dtool_cli-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dtool_cli` can be installed with:

```
conda install dtool_cli
```

It is possible to list all of the versions of `dtool_cli` available on your platform with:
